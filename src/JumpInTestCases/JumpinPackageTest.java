...
public class JumpinPackageTest {
	...
	// LevelRepository Tests
		...
		public void testGetLevelNames() {
			...
			System.out.println(lr.getLevelNames());
			names.add("default_easy.json");
			names.add("default_hard.json");
			names.add("default_medium.json");
			assertEquals("Level names are not equal.", lr.getLevelNames(), names);
		}
		*/
}
