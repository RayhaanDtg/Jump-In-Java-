...
/**
*  The Board class represents the board of spots for the elements to exist. This is where we
*  instantiate the holes and hills on the board. This also where we use the game elements in the
*  board.
*/
...
public class Board {
	...
	/**
	*  This takes in the number of bunnies that are being used in the game. A map of the element
	*  positions are created, as well as the holes for the board. From here all the spots are
	*  instantiated will hills and holes, and the board is built to be used in the game.
	*  @param bunnyCount
	*/

	public Board(final int bunnyCount) {
		this.bunnyCount = bunnyCount;
		elementPositions = Maps.newHashMap();
		holes = new ArrayList<>();
	...
	*/
	...
	/**
	*  This returns if all the spots marked as holes have bunnies there. If this is true this means the
	...
	*/
	...
	/**
	*  This method moves the element from its current position to a new position if it is a valid move.
	*  @param element
	*  @param position
	*/
	...
	*/
	...
	/**
	*  This method gets all the surrounding squares in range around the square that an element is
	*  currently on, based on the element being used and the direction to get the spot.
	*  @param element
	*  @param direction
	*  @return List<Spot>
	*/
	...
	/**
	*  This returns a list of all the elements in terms of its ID and associated coordinate. 
	*  @return String
	*/
	...
	/**
	*  This returns a spot from the position from getFoxTail given the element and its head position.
	*  @param element
	*  @param headPosition
	*  @return Spot
	*/
